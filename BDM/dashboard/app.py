...
import query
import logging
from gdb_connector import get_communities
    ...
    children=[
        html.Div(
            children=[
                ...
                html.P(children=html.Img(src=app.get_asset_url("zen-logo.png"), height=100, width=140), className="header-emoji"),
                html.H1(
                    children="ZEN Analytics", className="header-title"
                ),
                # html.P(
                #     children=(
